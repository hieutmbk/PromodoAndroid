...
public class TaskFragment extends Fragment {
    ...
    private void setupUI(View view) {
        ...
        appCompatActivity.getSupportActionBar().setTitle("Task Fragment");
    ...
    void onFabClick(){
        ...
        ManagerFragment managerFragment = new ManagerFragment(getActivity().getSupportFragmentManager(),R.id.fl_main);
        managerFragment.replaceFragment(taskDetailFragment,true);
    }
}
